...
const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ProductService.createProducts(product);
    try {
        res.status(200).send({
...
const updateroduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const product = req.body;
    yield ProductService.updateProducts(product);
    try {
        res.status(200).send({
...
const deleteproduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ProductService.deleteProducts(productID);
    try {
        res.status(200).send({
